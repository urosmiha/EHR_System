    ...
    function initUsers($conn) {
        ...
        if($result_check < 1) {
            ...
            */
            ...
            // Add data to the table - Called from the helper function
            addUser("9999999999999999", "Admin", "Admin", "G00", "root", $conn);
            addUser("8144263845012816", "John", "Smith", "G01", "D0oeyr", $conn); 
            addUser("2784314725024840", "Louis", "Barnett", "G01", "C1uSxm", $conn); 
            addUser("7213371884361708", "Agnes", "Bennett", "D40", "sdT0Tp", $conn); 
            addUser("0059733480442287", "Alice", "Bush", "G01", "M7GcxU", $conn); 
            addUser("7985433055533216", "Margaret", "Cruickshank", "G01", "zV0467", $conn); 
            addUser("1885596723202265", "Charles", "Farthing", "G01", "xK3S33", $conn); 
            addUser("9199387168431627", "Isaac", "Featherston", "G01", "iM4WPA", $conn); 
            addUser("9308606653138318", "Erich", "Geiringer", "G01", "ScbC48", $conn); 
            addUser("5003179885770554", "David", "Gerrard", "G01", "te5UgK", $conn); 
            addUser("6190510160717766", "Harold", "Gillies", "G01", "cW40H1", $conn); 
            addUser("4666029279298446", "Herb", "Green", "G01", "dYEf3o", $conn); 
            addUser("8089930693201074", "Elizabeth", "Gunn", "M10", "14YanP", $conn); 
            addUser("1800315856145240", "Ian", "Hassall", "M10", "sO00oJ", $conn); 
            addUser("4145907651023999", "Fred", "Hollows", "M10", "SK2vbB", $conn); 
            addUser("1768404315200940", "Paul", "Hutchison", "M10", "7iNHlW", $conn); 
            addUser("8434160307830941", "Tracy", "Inglis", "M10", "T8aa5v", $conn); 
            addUser("9459173006109210", "Truby", "King", "M10", "8zRB3U", $conn); 
            addUser("0861208656055662", "Ivan", "Lichter", "M15", "L1Fs4x", $conn); 
            addUser("3704251424826610", "Archibald", "McIndoe", "M15", "fyW97a", $conn); 
            addUser("3851215999088013", "Tracy", "Nedwill", "M15", "nY9Z4e", $conn);
            addUser("6054918944115923", "Archibald", "McIndoe", "M15", "p2C0Gm", $conn); 
            addUser("9972007019597607", "Brad", "McKay", "M15", "ZtXz4L", $conn); 
            addUser("6701270700133987", "Courtney", "Rogers", "M15", "5vLLyJ", $conn); 
            addUser("9347513593592194", "Denis", "Rogers", "M45", "VNsf0h", $conn); 
            addUser("1267526751444866", "Edward", "Sayers", "M45", "Ffcj6a", $conn); 
            addUser("3825608702780785", "Henry", "Thacker", "M45", "gnK1Zx", $conn); 
            addUser("3653765101474740", "Ronald", "Trubuhovich", "M45", "F1l8dq", $conn); 
            addUser("5834067021308404", "Thomas", "Valintine", "M50", "3iCcSB", $conn); 
            addUser("2796629485280519", "Leslie", "Whetter", "M50", "7bL54B", $conn); 
            addUser("8102019473634893", "Christine", "Winterbourn", "M50", "3Vh5Dp", $conn);  
        }
    }
    ...
    function initQuestions($conn) {
        ...
        if($result_check < 1) {
            ...
            *   status: 
                ...
                date - when was queation poste
            */
            $sql = "CREATE TABLE IF NOT EXISTS questions (id int(11) not null AUTO_INCREMENT PRIMARY KEY, 
                                                        qid varchar(25) not null, hsc varchar(255) not null, 
                                                        topic varchar(255) not null, title varchar(255) not null, 
                                                        content varchar(255) not null, user varchar(16) not null, 
                                                        likes int(11) not null, status varchar(20) not null, 
                                                        date date not null
                                                        );";
            $result = mysqli_query($conn, $sql);
        ...
        // 1
            ...
            addQuestion($qid, "G01", "General Practice", $title, $content, "0059733480442287", 5, "open", "2018-04-12", $conn);
        // 2
            ...
            addQuestion($qid, "G01", "General Practice",  $title, $content, "0059733480442287", 15, "open","2018-01-22", $conn);
        ...
        // 3
            ...
            addQuestion($qid, "G01", "General Practice",  $title, $content, "2784314725024840", 22, "open","2018-06-15", $conn);
        ...
        // 4
            ...
            addQuestion($qid, "D40", "Physiotherapy",  $title, $content, "7213371884361708", 7, "open","2018-07-18", $conn);
        }
    }
